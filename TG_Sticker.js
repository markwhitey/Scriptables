...
//可从该网站选择自己喜欢的贴纸：https://telegramchannels.me/stickers?category=all&sort=rating
// 例如：https://telegramchannels.me/stickers/s-getswifty ，则填入stickersName中的名称为getswifty，
// 以下为个人比较喜欢的贴纸
// 搞怪名画:  riposte  ,  paintingsplace
// Rick and Morty : getswifty
// 欧美小姐姐 : feelourlove 
// 辛普森一家 ： Bart
const stickersName = "feelourlove"
...
const stickerStartNum = 1;
const stickerSum = await getNum();
let randomStickerNum = parseInt(stickerStartNum + Math.random() * stickerSum).toString();
let imgUrl = "https://telegramchannels.me/storage/stickers/" + stickersName +"/big_" + stickersName + "_" + randomStickerNum +".png";
...
try {
    const request = new Request("https://telegramchannels.me/stickers/s-" + stickersName +"/")
...
             function getData() {
                    try {
                        imgnum = document.getElementsByClassName('subtitle is-6')[0].textContent.replace(/[^0-9]/ig,"");                
                        }
                    catch {
                         imgnum     
                    }
